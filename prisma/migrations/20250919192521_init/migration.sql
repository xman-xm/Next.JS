...
*/
-- DropIndex
DROP INDEX "public"."Post_body_key";
...
CREATE TABLE "public"."Commnts" (
    ...
    CONSTRAINT "Commnts_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "public"."Commnts" ADD CONSTRAINT "Commnts_postId_fkey" FOREIGN KEY ("postId") REFERENCES "public"."Post"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Commnts" ADD CONSTRAINT "Commnts_AuthorId_fkey" FOREIGN KEY ("AuthorId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
